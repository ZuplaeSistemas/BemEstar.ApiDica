...
{
    public class RepositoryInMySql<T> : IRepository<T> where T : BaseModel
    {
        private IDbConnectionFactory _dbConnectionFactory;
        private readonly string tablename = typeof(T).Name.ToLower(); //Reflection
        public RepositoryInMySql(IDbConnectionFactory dbConnectionFactory)
        {
